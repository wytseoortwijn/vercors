...
import vct.parsers.Java7Parser.*;
import vct.parsers.*;
import vct.parsers.Java7Parser.ClassBodyContext;
import vct.parsers.Java7Parser.ClassBodyDeclarationContext;
import vct.parsers.Java7Parser.SpecificationModifierContext;
import vct.parsers.Java7Parser.SpecificationPrimaryContext;
import vct.parsers.Java7Parser.SpecificationPrimitiveTypeContext;
import vct.parsers.Java7Parser.SpecificationStatementContext;
...
*/
public class Java7ToCol extends AbstractJava7ToCol implements Java7Visitor<ASTNode> {
  ...
  public static ProgramUnit convert(ParseTree tree, String file_name,BufferedTokenStream tokens,Parser parser) {
    ...
    Java7ToCol visitor=new Java7ToCol(unit,JavaSyntax.getJava(),file_name,tokens,parser);
    visitor.scan_to(unit,tree);
    return unit;
  }

  public Java7ToCol(ASTSequence<?> unit,Syntax syntax, String filename, BufferedTokenStream tokens,
      Parser parser) {
    super(unit,syntax, filename, tokens, parser, Java7Lexer.Identifier, Java7Lexer.COMMENT,Java7Lexer.class);
  }
