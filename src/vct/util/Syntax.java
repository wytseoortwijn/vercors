...
public class Syntax {
  ...
  private Map<StandardOperator,Integer> precedence_map = new EnumMap(StandardOperator.class);
  private Map<StandardOperator,String[]> syntax_map = new EnumMap(StandardOperator.class);
  private Map<StandardOperator,Associativity> associativity_map = new EnumMap(StandardOperator.class);
  private Map<Sort,String> type_map = new EnumMap(Sort.class);
