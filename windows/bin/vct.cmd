...
set VCT_PATH=%VCT_PATH%;%VCT_HOME%\vercors\target\scala-2.12\classes
...
set VCT_PATH=%VCT_PATH%;%VCT_HOME%\viper\silicon\target\scala-2.12
set VCT_PATH=%VCT_PATH%;%VCT_HOME%\viper\silicon\target\scala-2.12\classes
